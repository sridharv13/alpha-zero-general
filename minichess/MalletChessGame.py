...
class MalletChessGame(Game):
    RECURSION_LIMIT = 1000
    def __init__(self, n=5):
        self.n = n
        self.setAllActions()
    def getInitBoard(self):
        sys.setrecursionlimit(MalletChessGame.RECURSION_LIMIT)
        # return initial board (numpy board)
        b = Board(self.n,
            [
                #  Representation of Baby Chess Board
                #
                # 5    ♜ ♝ ♚ ♛ ♝
                # 4    ♟ ♟ ♟ ♟ ♟
                # 3    ·  ·  ·  ·  ·
                ...
                [-Board.ROOK, -Board.BISHOP, -Board.KING, -Board.QUEEN, -Board.BISHOP],
                [-Board.PAWN, -Board.PAWN, -Board.PAWN, -Board.PAWN, -Board.PAWN],
                [Board.BLANK, Board.BLANK,   Board.BLANK,   Board.BLANK, Board.BLANK],
                [Board.PAWN, Board.PAWN, Board.PAWN, Board.PAWN, Board.PAWN],
                [Board.ROOK, Board.KNIGHT, Board.KING, Board.QUEEN, Board.KNIGHT],
            ]
        )
