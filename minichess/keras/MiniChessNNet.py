...
"""
NeuralNet for the game of MiniChess.
...
class MiniChessNNet():
    def __init__(self, game, args):
        ...
        s_fc1 = Dropout(args.dropout)(Activation('relu')(BatchNormalization(axis=1)(Dense(2048)(h_conv4_flat))))  # batch_size x 1024
        s_fc2 = Dropout(args.dropout)(Activation('relu')(BatchNormalization(axis=1)(Dense(2048)(s_fc1))))          # batch_size x 1024
        self.pi = Dense(self.action_size, activation='sigmoid', name='pi')(s_fc2)   # batch_size x self.action_size
